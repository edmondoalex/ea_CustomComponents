...
- Per ogni snapshot viene provato prima il main stream (`stream=0`) e, se non restituisce un'immagine valida, il substream (`stream=1`) dello stesso canale.
